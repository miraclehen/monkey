...
import com.jackson.monkey.loader.AlbumMediaLoader;
...
public class AlbumMediaCollection implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void reloadForCapture(@Nullable Album target) {
        mLoaderManager.restartLoader(LOADER_ID, makeArgument(target, false,false), this);
    }
