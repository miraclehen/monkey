...
public class AlbumMediaLoader extends CursorLoader {
    ...
    public Cursor loadInBackground() {
        ...
        if (mEnableCapture) {
            //添加拍照视图
            dummy.addRow(new Object[]{MediaItem.ITEM_ID_CAPTURE, MediaItem.ITEM_DISPLAY_NAME_CAPTURE, "", 0, System.currentTimeMillis(), 0D, 0D, 0L, 0L, "",0});
        } else {
            //添加录像视图
            dummy.addRow(new Object[]{MediaItem.ITEM_ID_RECORD, MediaItem.ITEM_DISPLAY_NAME_RECORD, "", 0, System.currentTimeMillis(), 0D, 0D, 0L, 0L,"", 0});
        }
