...
import com.miraclehen.monkey.ui.adapter.PreviewPagerAdapter;
import com.miraclehen.monkey.ui.widget.CheckView;
import com.miraclehen.monkey.utils.PhotoMetadataUtils;
import com.miraclehen.monkey.utils.Platform;
...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void updateSize(MediaItem item) {
        if (item.isGif()) {
            ...
            mSize.setText(PhotoMetadataUtils.getSizeInMB(item.length) + "M");
        } else {
