...
//        return data.getParcelableArrayListExtra(MonkeyActivity.EXTRA_RESULT_SELECTION);
        ArrayList<MediaItem> itemArrayList = data.getParcelableArrayListExtra(MonkeyActivity.EXTRA_RESULT_SELECTION_ITEM);
        ArrayList<Uri> result = new ArrayList<>();
        for (MediaItem item : itemArrayList) {
